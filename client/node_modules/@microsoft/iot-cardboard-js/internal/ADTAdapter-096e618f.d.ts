...
declare type OatIconNames = 'BufferTimeBefore' | 'BulletedList2' | 'Calendar' | 'Clock' | 'Code' | 'CubeShape' | 'DateTime' | 'DocumentManagement' | 'Down' | 'GroupList' | 'TextField' | 'ToggleRight' | 'Up';
...
declare class AdapterMethodSandbox {
     ...
     *  */
    safelyFetchData<T extends IAdapterData>(fetchDataWithToken: (token?: string) => Promise<T>, tokenFor?: 'azureManagement' | 'adx' | 'storage'): Promise<AdapterResult<T>>;
    safelyFetchDataCancellableAxiosPromise(returnDataClass: {
        new (data: any): any;
    }, axiosParams: AxiosParams, dataTransformFunc?: (data: any) => any, tokenFor?: 'azureManagement' | 'adx' | 'storage'): ICancellablePromise<AdapterResult<any>>;
}
...
declare class BlobAdapter implements IBlobAdapter {
    ...
    constructor(blobContainerUrl: string, authService: IAuthService, blobProxyServerPath?: string);
...
declare class ADT3DSceneAdapter {
    constructor(authService: IAuthService, adtHostUrl: string, blobContainerUrl?: string, tenantId?: string, uniqueObjectId?: string, adtProxyServerPath?: string, blobProxyServerPath?: string);
...
interface ADT3DSceneAdapter extends ADTAdapter, BlobAdapter, AzureManagementAdapter, ADXAdapter {
    getMissingStorageContainerAccessRoles: (containerURLString?: string) => Promise<AdapterResult<AzureMissingRoleDefinitionsData>>;
    addMissingRolesToStorageContainer: (missingRoleDefinitionIds: AzureAccessPermissionRoleGroups) => Promise<AdapterResult<AzureResourcesData>>;
}
...
declare class MockAdapter implements IKeyValuePairAdapter, IADT3DViewerAdapter, IBlobAdapter, Partial<IADTAdapter>, IPropertyInspectorAdapter, IModelledPropertyBuilderAdapter {
    private mockData;
    private mockError;
    mockTwins: IADTTwin[];
    mockModels: DtdlInterface[];
    ...
    getTimeSeriesData(seriesIds: Array<string>, query: string): Promise<AdapterResult<ADXTimeSeriesData>>;
...
interface IAuthService {
    login: () => void;
    getToken: (tokenFor?: 'azureManagement' | 'adx' | 'storage') => Promise<string>;
}
...
declare type IQueryBuilderAdapter = ADTAdapter | MockAdapter;
...
interface IADT3DViewerProps extends BaseComponentProps {
    adapter: IADT3DViewerAdapter | (IADT3DViewerAdapter & IPropertyInspectorAdapter & IADXAdapter);
    sceneId: string;
    scenesConfig: I3DScenesConfig;
    title?: string;
...
declare class ADTAdapter implements IADTAdapter {
    ...
    constructor(adtHostUrl: string, authService: IAuthService, tenantId?: string, uniqueObjectId?: string, adtProxyServerPath?: string);
    getAdtHostUrl(): string;
    setAdtHostUrl(hostName: string): void;
...
export { IADTModelDefinition as $, ADTAdapter as A, BlobAdapter as B, CustomMeshItem as C, IAdapterData as D, IUseAdapter as E, IComponentError as F, IMockAdapter as G, IMockError as H, IADTObjectColor as I, IErrorInfo as J, KeyValuePairAdapterData as K, IHierarchyProps as L, MockAdapter as M, IHierarchyNode as N, IAzureResources as O, IAzureResource as P, IAzureRoleAssignment as Q, IADTInstance as R, IAzureStorageAccount as S, IAzureStorageBlobContainer as T, IAzureTimeSeriesDatabaseConnection as U, IAzureRoleAssignmentPropertyData as V, IADTInstancePropertyData as W, IAzureStorageAccountPropertyData as X, IAzureTimeSeriesDatabaseConnectionPropertyData as Y, IADXConnection as Z, IADTModel as _, IADTBackgroundColor as a, AdapterResultParams as a$, IADTTwin as a0, IADTRelationship as a1, IADTProperty as a2, IADTTwinComponent as a3, IGetKeyValuePairsAdditionalParameters as a4, IResolvedRelationshipClickErrors as a5, IViewData as a6, IEntityInfo as a7, ISearchboxProps as a8, ICancellablePromise as a9, DTwinRelationship as aA, IAdtPusherSimulation as aB, AdtPusherSimulationType as aC, IGenerateADTAssetsProps as aD, IJSONUploaderProps as aE, IJSONUploaderFileItem as aF, IADTInstancesProps as aG, IADT3DGlobeProps as aH, ADT3DAddInEventData as aI, IADT3DAddInProps as aJ, ISceneViewWrapperProps as aK, IADT3DViewerProps as aL, ISceneViewerThemeCache as aM, IStorageBlob as aN, IAliasedTwinProperty as aO, ILanguageOption as aP, DTDLPropertySchema as aQ, DTDLPropertyEnumValue as aR, IOATNodeElement as aS, IOATNodePosition as aT, IOATRelationshipElement as aU, IOATLastPropertyFocused as aV, IOATProperty as aW, IBlobServiceCorsRule as aX, IDataHistoryTimeSeriesTwin as aY, IChartOption as aZ, AdapterReturnType as a_, IKeyValuePairAdapter as aa, IPropertyInspectorAdapter as ab, IModelledPropertyBuilderAdapter as ac, IQueryBuilderAdapter as ad, IADT3DViewerAdapter as ae, IADTAdapter as af, IAzureManagementAdapter as ag, IBlobAdapter as ah, IADXAdapter as ai, IBaseStandardModelSearchAdapter as aj, IModelSearchStringParams as ak, IStandardModelSearchAdapter as al, IStandardModelSearchItem as am, IStandardModelSearchResult as an, IStandardModelIndexData as ao, DTwinUpdateEvent as ap, ADTPatch as aq, SimulationParams as ar, IADTModelImages as as, IADTModelImageContent as at, AssetRelationship as au, AssetTwin as av, IAssetProperty as aw, DTModelContent as ax, DTModel as ay, DTwin as az, ADXAdapter as b, CharacterWidths as b$, AxiosParams as b0, AxiosObjParam as b1, AdapterState as b2, KeyValuePairData as b3, BIMData as b4, ADTRelationship as b5, ADXTimeSeriesTableRow as b6, TimeSeriesData as b7, ADXTimeSeries as b8, HierarchyData as b9, AzureResourceFetchParamsForResourceProvider as bA, AzureResourceFetchParams as bB, ADXTable as bC, ADTModel_ImgSrc_PropertyName as bD, ADTModel_ViewData_PropertyName as bE, ADTModel_ImgPropertyPositions_PropertyName as bF, ADTModel_InBIM_RelationshipName as bG, ADTModel_BimFilePath_PropertyName as bH, ADTModel_MetadataFilePath_PropertyName as bI, ADTModel_BIMContainerId as bJ, ADT_ApiVersion as bK, ViewDataPropertyName as bL, BoardInfoPropertyName as bM, DTMIRegex as bN, DTDLNameRegex as bO, SCENES_DEMO_URL as bP, DOCUMENTATION_LINKS as bQ, DEFAULT_REFRESH_RATE_IN_MILLISECONDS as bR, ONE_SECOND as bS, ONE_MINUTE as bT, ONE_HOUR as bU, LOCAL_STORAGE_KEYS as bV, dtdlPrimitiveTypesList as bW, dtdlPropertyTypesEnum as bX, PropertyValueType as bY, dtdlComplexTypesList as bZ, ADTSceneTwinModelId as b_, ADTModelsApiData as ba, ADTTwinsApiData as bb, CancellablePromise as bc, UseLongPollParams as bd, ImgPropertyPositions as be, AdapterMethodParams as bf, AdapterMethodParamsForGetADTModels as bg, AdapterMethodParamsForGetADTTwinsByModelId as bh, AdapterMethodParamsForSearchADTTwins as bi, AdapterMethodParamsForSearchTwinsByQuery as bj, AdapterMethodParamsForGetTwinsByQuery as bk, AdapterMethodParamsForGetScenes as bl, ADTRelationshipsApiData as bm, AssetsFromBIMState as bn, AdapterTypes as bo, IIconNames as bp, CardboardIconNames as bq, OatIconNames as br, DurationUnits as bs, IConsoleLogFunction as bt, AzureAccessPermissionRoleGroups as bu, AdapterMethodParamsForGetAzureResources as bv, AzureResourceSearchParams as bw, AzureResourceSearchParamsWithAdditionalParams as bx, AzureResourceSearchParamsWithoutAdditionalParams as by, AzureResourceFetchParamsForResourceGraph as bz, ADT3DSceneAdapter as c, DtdlReference as c$, ADT3DSceneConfigFileNameInBlobStore as c0, availableWidgets as c1, twinRefreshMaxAge as c2, modelRefreshMaxAge as c3, timeSeriesConnectionRefreshMaxAge as c4, PRIMARY_TWIN_NAME as c5, DTID_PROPERTY_NAME as c6, dtIdModel as c7, ValidAdtHostSuffixes as c8, ValidContainerHostSuffixes as c9, OAT_DISPLAY_NAME_LENGTH_LIMIT as cA, OAT_NAME_LENGTH_LIMIT as cB, OAT_ID_LENGTH_LIMIT as cC, SelectedCameraInteractionKey as cD, ViewerThemeStorageKey as cE, defaultValueRangeColor as cF, StyleConstants as cG, intellisenseMultilineBreakpoint as cH, CardboardClassNamePrefix as cI, globeUrl as cJ, DTDLPropertyIconographyMap as cK, propertySelectorData as cL, BlobStorageServiceCorsAllowedOrigins as cM, BlobStorageServiceCorsAllowedMethods as cN, BlobStorageServiceCorsAllowedHeaders as cO, EnforcedStorageAccountAccessRoleIds as cP, InterchangeableStorageAccountAccessRoleIds as cQ, RequiredAccessRoleGroupForStorageAccount as cR, EnforcedStorageContainerAccessRoleIds as cS, InterchangeableStorageContainerAccessRoleIds as cT, RequiredAccessRoleGroupForStorageContainer as cU, EnforcedADTInstanceAccessRoleIds as cV, InterchangeableADTInstanceAccessRoleIds as cW, RequiredAccessRoleGroupForADTInstance as cX, CONNECTION_STRING_SUFFIX as cY, QuickTimeSpans as cZ, AggregationTypeDropdownOptions as c_, DefaultViewerModeObjectColor as ca, ViewerModeObjectColors as cb, TransparentTexture as cc, ViewerModeBackgroundColors as cd, EnvironmentsLocalStorageKey as ce, ContainersLocalStorageKey as cf, StorageAccountsLocalStorageKey as cg, SelectedEnvironmentLocalStorageKey as ch, SelectedContainerLocalStorageKey as ci, SELECTED_ENVIRONMENT_LOCAL_STORAGE_KEY as cj, SELECTECTED_CONTAINER_LOCAL_STORAGE_KEY as ck, OAT_FILES_STORAGE_KEY as cl, OAT_LAST_PROJECT_STORAGE_KEY as cm, OAT_UNTARGETED_RELATIONSHIP_NAME as cn, OAT_RELATIONSHIP_HANDLE_NAME as co, OAT_COMPONENT_HANDLE_NAME as cp, OAT_EXTEND_HANDLE_NAME as cq, OatReferenceType as cr, OatGraphReferenceType as cs, OAT_UNTARGETED_RELATIONSHIP_ID_PREFIX as ct, OAT_INTERFACE_TYPE as cu, OAT_GRAPH_REFERENCE_TYPE as cv, OAT_DEFAULT_PATH_VALUE as cw, OAT_MODEL_ID_PREFIX as cx, OAT_COMMENT_LENGTH_LIMIT as cy, OAT_DESCRIPTION_LENGTH_LIMIT as cz, AzureManagementAdapter as d, DtdlInterfaceContent as d0, DtdlInterface as d1, DtdlInterfaceSchema as d2, DtdlComponent as d3, DtdlRelationship as d4, DtdlCommand as d5, CommandPayload as d6, DtdlProperty as d7, DtdlArray as d8, DtdlMapKey as d9, DtdlMapValue as da, DtdlMap as db, DtdlObject as dc, DtdlObjectField as dd, DtdlEnum as de, DtdlEnumValueSchema as df, DtdlEnumValue as dg, StandardModelIndexData as dh, StandardModelData as di, StandardModelSearchData as dj, SceneVisual as dk, SceneViewBadgeGroup as dl, TransformedElementItem as dm, TransformInfo as dn, ISceneViewProps as dp, IWidgetLibraryItem as dq, IBehaviorTwinAliasItem as dr, IElementTwinAliasItem as ds, ADTAdapterModelsData as e, ADTAdapterTwinsData as f, ADTModelData as g, ADTRelationshipsData as h, ADTRelationshipData as i, ADTTwinData as j, AdapterMethodSandbox as k, AdapterResult as l, ComponentError as m, CancelledPromiseError as n, IAction as o, IBIMViewerProps as p, ITSIChartComponentProps as q, ICardBaseProps as r, IStandaloneConsumeCardProps as s, IConsumeCardProps as t, IErrorComponentProps as u, IErrorButtonAction as v, IOverlayProps as w, IConsumeCompositeCardProps as x, IAuthService as y, IEnvironmentToConstantMapping as z };
