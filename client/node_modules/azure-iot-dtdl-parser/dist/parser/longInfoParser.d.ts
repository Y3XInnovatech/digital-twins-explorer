...
export declare class LongInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: LongInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=longInfoParser.d.ts.map