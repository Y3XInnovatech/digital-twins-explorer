...
export declare class IntegerInfoParser {
    protected static _concreteKinds: {
        [x: number]: IntegerKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: IntegerInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=integerInfoParser.d.ts.map