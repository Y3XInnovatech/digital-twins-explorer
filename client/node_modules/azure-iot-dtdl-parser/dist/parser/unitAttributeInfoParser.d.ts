...
export declare class UnitAttributeInfoParser {
    protected static _concreteKinds: {
        [x: number]: UnitAttributeKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: UnitAttributeInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=unitAttributeInfoParser.d.ts.map