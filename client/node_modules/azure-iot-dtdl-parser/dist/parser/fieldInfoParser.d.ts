...
export declare class FieldInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: FieldInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=fieldInfoParser.d.ts.map