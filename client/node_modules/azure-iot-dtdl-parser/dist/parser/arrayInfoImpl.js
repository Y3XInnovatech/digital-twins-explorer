...
class ArrayInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this._elementSchemaInstanceProperties = [];
        this._elementSchemaAllowedVersionsV2 = new Set().add(2);
        this._elementSchemaAllowedVersionsV3 = new Set().add(3).add(2);
        this.parserClass = parserCollection_1.ParserCollection.ArrayInfoParser;
    ...
    doesHaveType(typeId) {
        return (ArrayInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
    ...
    instanceName) {
        ...
        for (const child of instanceElt) {
            if (!((_a = this.elementSchema) === null || _a === void 0 ? void 0 : _a.validateInstanceInternal(child, undefined))) {
                return false;
            }
        }
        return true;
    ...
    parsingErrors) {
        ...
        if (this._elementSchemaInstanceProperties !== undefined) {
            for (const instanceProp of this._elementSchemaInstanceProperties) {
                if (!((_a = this.elementSchema) === null || _a === void 0 ? void 0 : _a.validateInstanceElement(this.supplementalProperties[instanceProp]))) {
    ...
    parsingErrors) {
        ...
        if (this.elementSchema !== undefined) {
            if (!this.elementSchema.checkDepthOfElementSchemaOrSchema(depth + 1, depthLimit, tooDeepElementId, parsingErrors)) {
    ...
    parsingErrors) {
        ...
        if (this.elementSchema !== undefined) {
            this.elementSchema.checkDescendantEnumValueDataType(ancestorId, datatype, parsingErrors);
        }
    }
    ...
    tryGetDescendantSchemaArray(elementId) {
        ...
        if (this.elementSchema !== undefined) {
            if (this.elementSchema.tryGetDescendantSchemaArray(elementId)) {
    ...
    getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) {
        ...
        if (this.elementSchema !== undefined) {
            this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowValue +=
                this.elementSchema.getCountOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrow(parsingErrors) + 1;
        }
        this._countOfContentsOrFieldsOrEnumValuesOrRequestOrResponseOrPropertiesOrSchemaOrElementSchemaOrMapValueNarrowStatus =
            enum_1.TraversalStatus.Complete;
        return this
...
exports.ArrayInfoImpl = ArrayInfoImpl;
//# sourceMappingURL=arrayInfoImpl.js.map