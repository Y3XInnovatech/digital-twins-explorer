...
exports.IntegerInfoImpl = void 0;
...
class IntegerInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.IntegerInfoParser;
    ...
    doesHaveType(typeId) {
        return (IntegerInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.IntegerInfoImpl = IntegerInfoImpl;
//# sourceMappingURL=integerInfoImpl.js.map