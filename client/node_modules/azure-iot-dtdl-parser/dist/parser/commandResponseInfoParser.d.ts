...
export declare class CommandResponseInfoParser {
    protected static _concreteKinds: {
        [x: number]: CommandResponseKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: CommandResponseInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=commandResponseInfoParser.d.ts.map