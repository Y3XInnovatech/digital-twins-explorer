        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:enumValues;2":
                    valueCount = parserCollection_1.ParserCollection.EnumValueInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._enumValuesValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "enumValues", "name", undefined, false, false, allowIdReferenceSyntax, elementInfo._enumValuesAllowedVersionsV2);
                    if (valueCount < 1) {
                ...
                case "dtmi:dtdl:property:valueSchema;2":
                    ...
                    valueCount = parserCollection_1.ParserCollection.PrimitiveSchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._valueSchemaValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "valueSchema", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._valueSchemaAllowedVersionsV2);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
            ...
            if (EnumInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:enumValues;3":
                    parserCollection_1.ParserCollection.EnumValueInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._enumValuesValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "enumValues", "name", undefined, false, false, allowIdReferenceSyntax, elementInfo._enumValuesAllowedVersionsV3);
                    continue;
                case "valueSchema":
                case "dtmi:dtdl:property:valueSchema;3":
                    valueSchemaPropertyMissing = false;
                    valueCount = parserCollection_1.ParserCollection.PrimitiveSchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._valueSchemaValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "valueSchema", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._valueSchemaAllowedVersionsV3);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
                            cause: `{primaryId:p} property 'valueSchema' has value valueCount values, but the required minimum count is 1`,
                            action: `Add one or more 'valueSchema' to the object until the minimum count is satisfied.`,
...
exports.EnumInfoParser = EnumInfoParser;
//# sourceMappingURL=enumInfoParser.js.map