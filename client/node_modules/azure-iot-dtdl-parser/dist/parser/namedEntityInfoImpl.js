...
class NamedEntityInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.NamedEntityInfoParser;
    ...
    doesHaveType(typeId) {
        return NamedEntityInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless);
    }
...
exports.NamedEntityInfoImpl = NamedEntityInfoImpl;
//# sourceMappingURL=namedEntityInfoImpl.js.map