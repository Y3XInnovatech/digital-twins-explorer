...
class RootableTypeCollection {
    ...
    static get rootableTypeDescriptions() {
        return this._rootableTypeDescriptions;
    }
    static hasRootableType(obj, dtdlVersion) {
...
exports.RootableTypeCollection = RootableTypeCollection;
RootableTypeCollection._typeKeyword = "@type";
RootableTypeCollection.initialize();
//# sourceMappingURL=rootableTypeCollection.js.map