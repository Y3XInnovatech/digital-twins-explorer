...
class TimeInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.TimeInfoParser;
        this._elementValueInstanceRegexPatternV2 = /^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
        this._elementValueInstanceRegexPatternV3 = /^[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
    ...
    doesHaveType(typeId) {
        return (TimeInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.TimeInfoImpl = TimeInfoImpl;
//# sourceMappingURL=timeInfoImpl.js.map