...
export declare class ArrayInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: ArrayInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=arrayInfoParser.d.ts.map