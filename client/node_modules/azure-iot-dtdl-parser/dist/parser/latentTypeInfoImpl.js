...
exports.LatentTypeInfoImpl = void 0;
...
class LatentTypeInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.LatentTypeInfoParser;
    ...
    doesHaveType(typeId) {
        return (LatentTypeInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.LatentTypeInfoImpl = LatentTypeInfoImpl;
//# sourceMappingURL=latentTypeInfoImpl.js.map