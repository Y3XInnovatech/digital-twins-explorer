...
export declare class FloatInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: FloatInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=floatInfoParser.d.ts.map