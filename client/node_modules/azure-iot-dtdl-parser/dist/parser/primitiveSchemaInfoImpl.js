...
exports.PrimitiveSchemaInfoImpl = void 0;
const parserCollection_1 = require("./parserCollection");
const internalDtmi_1 = require("./internalDtmi");
class PrimitiveSchemaInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.PrimitiveSchemaInfoParser;
    ...
    doesHaveType(typeId) {
        return PrimitiveSchemaInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless);
    }
...
exports.PrimitiveSchemaInfoImpl = PrimitiveSchemaInfoImpl;
//# sourceMappingURL=primitiveSchemaInfoImpl.js.map