...
exports.MapValueInfoParser = void 0;
...
class MapValueInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (MapValueInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.MapValueInfoParser = MapValueInfoParser;
//# sourceMappingURL=mapValueInfoParser.js.map