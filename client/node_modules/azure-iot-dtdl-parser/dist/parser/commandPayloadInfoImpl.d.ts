...
export declare class CommandPayloadInfoImpl implements CommandPayloadInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    _schemaAllowedVersionsV2: Set<number>;
...
//# sourceMappingURL=commandPayloadInfoImpl.d.ts.map