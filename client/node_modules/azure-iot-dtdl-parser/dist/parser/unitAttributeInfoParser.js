...
exports.UnitAttributeInfoParser = void 0;
...
class UnitAttributeInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (UnitAttributeInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.UnitAttributeInfoParser = UnitAttributeInfoParser;
//# sourceMappingURL=unitAttributeInfoParser.js.map