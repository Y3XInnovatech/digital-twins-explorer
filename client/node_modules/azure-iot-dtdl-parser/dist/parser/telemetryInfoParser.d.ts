...
export declare class TelemetryInfoParser {
    protected static _concreteKinds: {
        [x: number]: TelemetryKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: TelemetryInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=telemetryInfoParser.d.ts.map