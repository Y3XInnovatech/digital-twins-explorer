...
exports.FieldInfoParser = void 0;
...
class FieldInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (FieldInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.FieldInfoParser = FieldInfoParser;
//# sourceMappingURL=fieldInfoParser.js.map