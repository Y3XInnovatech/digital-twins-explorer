...
exports.ContentInfoImpl = void 0;
...
class ContentInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.ContentInfoParser;
    ...
    doesHaveType(typeId) {
        return ContentInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless);
    }
...
exports.ContentInfoImpl = ContentInfoImpl;
