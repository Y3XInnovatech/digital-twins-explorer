        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:symbol;2":
                    elementInfo.symbol = valueParser_1.ValueParser.parseSingularStringToken(elementInfo.id, "symbol", propValue, undefined, undefined, parsingErrors);
                    continue;
            }
            if (UnitInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.UnitInfoParser = UnitInfoParser;
//# sourceMappingURL=unitInfoParser.js.map