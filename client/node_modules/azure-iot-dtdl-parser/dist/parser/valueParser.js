...
class ValueParser {
    static parseSingularStringToken(elementId, propertyName, token, maxLength, pattern, parsingErrors) {
        let value;
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringNoValue", {
            ...
            if (token.length === 0) {
                ...
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringMultipleValues", {
        ...
        if (value !== undefined && maxLength !== undefined && value.length > maxLength) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringTooLong", {
        ...
        if (value !== undefined && pattern !== undefined && !pattern.test(value)) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringInvalid", {
    ...
    static parseSingularIntegerToken(elementId, propertyName, token, minInclusive, maxInclusive, parsingErrors) {
        let value;
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:integerNoValue", {
                cause: `{primaryId:p} property '${propertyName}' has no value.`,
            ...
            if (token.length === 0) {
                ...
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:integerMultipleValues", {
                    cause: `{primaryId:p} property '${propertyName}' has multiple values but only one value is allowed.`,
                    action: `Remove all but one of the values of '${propertyName}'.`,
                    primaryId: elementId,
                    property: propertyName,
        ...
        if (value !== undefined &&
            ...
            value !== minInclusive) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:valueNotExact", {
            ...
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:valueBelowMin", {
            ...
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:valueAboveMax", {
    ...
    static parseSingularBooleanToken(elementId, propertyName, token, parsingErrors) {
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:booleanNoValue", {
                cause: `{primaryId:p} property '${propertyName}' has no value.`,
                action: `Provide an integer value for '${propertyName}'.`,
                primaryId: elementId,
                property: propertyName,
        ...
        if (Array.isArray(token)) {
            ...
            if (token.length > 1) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:booleanMultipleValues", {
                    cause: `{primaryId:p} property '${propertyName}' has multiple values but only one value is allowed.`,
                    action: `Remove all but one of the values of '${propertyName}'.`,
                    primaryId: elementId,
                    property: propertyName,
    ...
    static parseLangStringToken(elementId, propertyName, token, defaultLang, maxLength, pattern, parsingErrors) {
        let dict;
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringNoValue", {
                cause: `{primaryId:p} property '${propertyName}' has no value.`,
            ...
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringNotLangString", {
        ...
        if (maxLength !== undefined) {
            for (const langCode in dict) {
                if (dict[langCode].length > maxLength) {
                    parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringValueTooLong", {
        ...
        if (pattern !== undefined) {
            for (const langCode in dict) {
                if (!pattern.test(dict[langCode])) {
                    parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringValueInvalid", {
    ...
    static parseSingularLiteralToken(elementId, propertyName, token, parsingErrors) {
        let value;
        let typeFragment = "";
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:literalNoValue", {
                cause: `{primaryId:p} property '${propertyName}' has no value.`,
            ...
            if (token.length === 0) {
                ...
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:literalMultipleValues", {
                    cause: `{primaryId:p} property '${propertyName}' has multiple values but only one value is allowed.`,
                    action: `Remove all but one of the values of '${propertyName}'.`,
                    primaryId: elementId,
                    property: propertyName,
                ...
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:literalNotValid", {
    ...
    static parseSingularIdentifierToken(elementId, propertyName, token, maxLength, pattern, parsingErrors) {
        let value;
        if (token === undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:identifierNoValue", {
                cause: `{primaryId:p} property '${propertyName}' has no value.`,
        ...
        if (Array.isArray(token)) {
            ...
            if (token.length > 1) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:identifierMultipleValues", {
                    cause: `{primaryId:p} property '${propertyName}' has multiple values but only one value is allowed.`,
                    action: `Remove all but one of the values of '${propertyName}'.`,
                    primaryId: elementId,
                    property: propertyName,
            ...
            if (typeof token[0] !== "string") {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:identifierNotString", {
        ...
        if (maxLength !== undefined && value.length > maxLength) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:identifierTooLong", {
                cause: `{primaryId:p} property '${propertyName}' has value '${value}', which is too long -- length limit is ${maxLength}.`,
                action: `Select a shorter value for '${propertyName}' or trim current value to fewer than ${maxLength} characters.`,
                primaryId: elementId,
                property: propertyName,
        ...
        if (pattern !== undefined && !pattern.test(value)) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:identifierInvalid", {
    ...
    static _getStringFromToken(elementId, propertyName, token, parsingErrors) {
        if (typeof token === "object") {
            if (!Object.prototype.hasOwnProperty.call(token, "@value")) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringObjectNoValue", {
            ...
            const valToken = token ? token["@value"] : null;
            if (typeof valToken !== "string") {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringValueNotString", {
        ...
        if (typeof token !== "string") {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:stringNotString", {
                cause: `{primaryId:p} property '${propertyName}' has value ${JSON.stringify(token)}, which is not a JSON string.`,
    ...
    static _getIntegerFromToken(elementId, propertyName, token, parsingErrors) {
        if (typeof token === "object") {
            if (!Object.prototype.hasOwnProperty.call(token, "@value")) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:integerObjectNoValue", {
                    cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object with no '@value' property.`,
            ...
            if (typeof valToken !== "number" || !Number.isInteger(valToken)) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:integerValueNotInteger", {
        ...
        if (typeof token !== "number" || !Number.isInteger(token)) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:integerNotInteger", {
    ...
    static _getBooleanFromToken(elementId, propertyName, token, parsingErrors) {
        if (typeof token === "object") {
            if (!Object.prototype.hasOwnProperty.call(token, "@value")) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:booleanObjectNoValue", {
                    cause: `{primaryId:p} property '${propertyName}' has value that is a JSON object with no '@value' property.`,
            ...
            if (typeof valToken !== "boolean") {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:booleanValueNotBoolean", {
        ...
        if (typeof token !== "boolean") {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:booleanNotBoolean", {
    ...
    static _getDictionaryFromLanguageTaggedStringArray(elementId, propertyName, array, parsingErrors) {
        const dict = {};
        for (const element of array) {
            if (typeof element !== "object") {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementNotObject", {
                ...
                if (!Object.prototype.hasOwnProperty.call(element, "@language")) {
                    parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementNoCode", {
                    ...
                    if (typeof codeToken !== "string") {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementCodeNotString", {
                        ...
                        if (!this._isValidLanguageCode(langCode)) {
                            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementInvalidCode", {
                        ...
                        if (Object.prototype.hasOwnProperty.call(dict, langCode)) {
                            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementCodeNotUnique", {
                ...
                if (!Object.prototype.hasOwnProperty.call(element, "@value")) {
                    parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementNoValue", {
                    ...
                    const valToken = element ? element["@value"] : null;
                    if (typeof valToken !== "string") {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringElementValueNotString", {
                            cause: `{primaryId:p} property '${propertyName}' array has element with '@value' value '${JSON.stringify(valToken)}', which is not a JSON string.`,
    ...
    static _getDictionaryFromLanguageMap(elementId, propertyName, obj, parsingErrors) {
        const dict = {};
        // eslint-disable-next-line guard-for-in
        for (const langCode in obj) {
            let assignOk = true;
            if (!this._isValidLanguageCode(langCode)) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringInvalidCode", {
            ...
            if (typeof langValue !== "string") {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:langStringValueNotString", {
    ...
    static _isValidLanguageCode(langCode) {
