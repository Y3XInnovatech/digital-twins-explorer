...
exports.PropertyInfoImpl = void 0;
...
class PropertyInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.PropertyInfoParser;
    ...
    doesHaveType(typeId) {
        return (PropertyInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
    ...
    parsingErrors) {
        ...
        const excludedArrayElementId = { ref: undefined };
...
exports.PropertyInfoImpl = PropertyInfoImpl;
//# sourceMappingURL=propertyInfoImpl.js.map