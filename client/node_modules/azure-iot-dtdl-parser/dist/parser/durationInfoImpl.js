...
exports.DurationInfoImpl = void 0;
...
class DurationInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.DurationInfoParser;
        this._elementValueInstanceRegexPatternV2 = /^P(?!$)(?:(?:\d+Y)|(?:\d+\.\d+Y$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:(?:\d+D)|(?:\d+\.\d+D$))?(?:T(?!$)(?:(?:\d+H)|(?:\d+\.\d+H$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:\d+(?:\.\d+)?S)?)?$/;
        this._elementValueInstanceRegexPatternV3 = /^P(?!$)(?:(?:\d+Y)|(?:\d+\.\d+Y$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:(?:\d+D)|(?:\d+\.\d+D$))?(?:T(?!$)(?:(?:\d+H)|(?:\d+\.\d+H$))?(?:(?:\d+M)|(?:\d+\.\d+M$))?(?:\d+(?:\.\d+)?S)?)?$/;
    ...
    doesHaveType(typeId) {
        return (DurationInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.DurationInfoImpl = DurationInfoImpl;
//# sourceMappingURL=durationInfoImpl.js.map