...
class EnumValueInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.EnumValueInfoParser;
    ...
    doesHaveType(typeId) {
        return (EnumValueInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    instanceName) {
        if (!literalValidator_1.LiteralValidator.hasValue(instanceElt, this.enumValue)) {
            return false;
        }
        return true;
    }
    ...
    parsingErrors) {
        if (this._checkedDescendantEnumValueDatatype !== datatype) {
            ...
            if (typeof this.enumValue !== datatype) {
                parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:nonConformantDatatype", {
...
exports.EnumValueInfoImpl = EnumValueInfoImpl;
//# sourceMappingURL=enumValueInfoImpl.js.map