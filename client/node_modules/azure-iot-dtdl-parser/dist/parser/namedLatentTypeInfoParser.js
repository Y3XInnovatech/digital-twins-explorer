...
exports.NamedLatentTypeInfoParser = void 0;
...
class NamedLatentTypeInfoParser {
    static initialize() {
        this._concreteKinds = {};
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (NamedLatentTypeInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.NamedLatentTypeInfoParser = NamedLatentTypeInfoParser;
//# sourceMappingURL=namedLatentTypeInfoParser.js.map