...
export declare class DurationInfoImpl implements DurationInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    sourceObject: any;
    _elementValueInstanceRegexPatternV2: RegExp;
    _elementValueInstanceRegexPatternV3: RegExp;
    isPartition: boolean;
...
//# sourceMappingURL=durationInfoImpl.d.ts.map