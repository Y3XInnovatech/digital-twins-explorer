...
exports.SchemaFieldInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:schema;2":
                    ...
                    valueCount = parserCollection_1.ParserCollection.SchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, [], aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "schema", undefined, undefined, false, true, allowIdReferenceSyntax, elementInfo._schemaAllowedVersionsV2);
                    if (valueCount < 1) {
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:schema;3":
                    schemaPropertyMissing = false;
                    valueCount = parserCollection_1.ParserCollection.SchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, [], aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "schema", undefined, undefined, false, true, allowIdReferenceSyntax, elementInfo._schemaAllowedVersionsV3);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
                            cause: `{primaryId:p} property 'schema' has value valueCount values, but the required minimum count is 1`,
                            action: `Add one or more 'schema' to the object until the minimum count is satisfied.`,
...
exports.SchemaFieldInfoParser = SchemaFieldInfoParser;
//# sourceMappingURL=schemaFieldInfoParser.js.map