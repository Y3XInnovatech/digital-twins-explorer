...
exports.CommandRequestInfoParser = void 0;
...
class CommandRequestInfoParser {
    static initialize() {
        this._concreteKinds = {};
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (CommandRequestInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.CommandRequestInfoParser = CommandRequestInfoParser;
//# sourceMappingURL=commandRequestInfoParser.js.map