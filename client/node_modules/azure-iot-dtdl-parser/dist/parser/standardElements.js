...
exports.StandardElements = void 0;
...
class StandardElements {
    ...
    static getDigestElements() {
        return [
            ...
            },
            {
                ...
                "@type": "Date",
                displayName: "date",
                description: "a date in ISO 8601 format, per [RFC 3339](https://tools.ietf.org/html/rfc3339)",
            },
            {
                "@context": "dtmi:dtdl:context;2",
                ...
                description: "a date and time in ISO 8601 format, per [RFC 3339](https://tools.ietf.org/html/rfc3339)",
            },
            {
                "@context": "dtmi:dtdl:context;2",
            ...
            },
            {
                ...
                "@type": "Time",
                displayName: "time",
                description: "a time in ISO 8601 format, per [RFC 3339](https://tools.ietf.org/html/rfc3339)",
            },
            {
                "@context": "dtmi:dtdl:context;2",
            ...
            },
            {
                ...
                "@type": "Object",
                fields: [
                    { "@id": "dtmi:iotcentral:schema:vector:x;2", "@type": "Field", name: "x", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:vector:y;2", "@type": "Field", name: "y", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:vector:z;2", "@type": "Field", name: "z", schema: "double" },
                ],
            },
            {
                "@context": ["dtmi:dtdl:context;2", "dtmi:iotcentral:context;2"],
                ...
                "@type": "Object",
                fields: [
                    { "@id": "dtmi:iotcentral:schema:geopoint:lon;2", "@type": "Field", name: "lon", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:geopoint:lat;2", "@type": "Field", name: "lat", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:geopoint:alt;2", "@type": "Field", name: "alt", schema: "double" },
                ],
            },
            {
                ...
                "@type": "Object",
                fields: [
                    { "@id": "dtmi:iotcentral:schema:vector:x;3", "@type": "Field", name: "x", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:vector:y;3", "@type": "Field", name: "y", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:vector:z;3", "@type": "Field", name: "z", schema: "double" },
                ],
            },
            {
                "@context": ["dtmi:dtdl:context;3", "dtmi:iotcentral:context;3"],
                ...
                "@type": "Object",
                fields: [
                    { "@id": "dtmi:iotcentral:schema:geopoint:lon;3", "@type": "Field", name: "lon", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:geopoint:lat;3", "@type": "Field", name: "lat", schema: "double" },
                    { "@id": "dtmi:iotcentral:schema:geopoint:alt;3", "@type": "Field", name: "alt", schema: "double" },
                ],
            },
        ];
    }
    ...
    static initialize() {
        this._standardModel = new model_1.Model();
        this._elementReferences = {};
        const objectPropertyInfoList = [];
        const aggregateContext = new aggregateContext_1.AggregateContext(true, true);
        const parsingErrors = [];
        ...
        for (const objectPropertyInfo of objectPropertyInfoList) {
            if (!this._elementReferences[objectPropertyInfo.elementId]) {
                this._elementReferences[objectPropertyInfo.elementId] = new Set();
            }
            // TODO FOR LATER : How is 1 dtmi related to a set ?
            this._elementReferences[objectPropertyInfo.elementId].add(new internalDtmi_1.InDTMI(objectPropertyInfo.referencedElementId));
        }
        this._standardModel.setObjectProperties(objectPropertyInfoList, parsingErrors);
    }
    static tryAddElementToModel(model, elementId) {
    ...
    static parseResourceIntoStandardModel(resource, objectPropertyInfoList, aggregateContext, parsingErrors) {
        for (const modelElement of resource) {
            modelParserStatic_1.ModelParserStatic.parseObject(this._standardModel, objectPropertyInfoList, [], aggregateContext.getChildContext(modelElement, parsingErrors), parsingErrors, modelElement);
        }
...
exports.StandardElements = StandardElements;
//# sourceMappingURL=standardElements.js.map