...
exports.CommandResponseInfoParser = void 0;
...
class CommandResponseInfoParser {
    static initialize() {
        this._concreteKinds = {};
    ...
    allowIdReferenceSyntax, allowedVersions) {
        ...
        switch (childAggregateContext.dtdlVersion) {
            case 3: {
                if (((_a = elementInfo.parserClass) === null || _a === void 0 ? void 0 : _a.parsePropertiesV3) !== undefined) {
                    (_b = elementInfo.parserClass) === null || _b === void 0 ? void 0 : _b.parsePropertiesV3(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, childAggregateContext, parsingErrors, object, definedIn, allowIdReferenceSyntax);
                }
                break;
            }
        }
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (CommandResponseInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.CommandResponseInfoParser = CommandResponseInfoParser;
//# sourceMappingURL=commandResponseInfoParser.js.map