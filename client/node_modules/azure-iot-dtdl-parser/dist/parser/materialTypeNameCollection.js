...
exports.MaterialTypeNameCollection = void 0;
/**
 * A collection of all material type names
 **/
class MaterialTypeNameCollection {
    static initialize() {
        MaterialTypeNameCollection.typeNames = new Set();
    ...
    static isMaterialType(typeString) {
        return MaterialTypeNameCollection.typeNames.has(typeString);
    }
}
exports.MaterialTypeNameCollection = MaterialTypeNameCollection;
MaterialTypeNameCollection.initialize();
//# sourceMappingURL=materialTypeNameCollection.js.map