...
export declare class CommandTypeInfoParser {
    protected static _concreteKinds: {
        [x: number]: CommandTypeKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: CommandTypeInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=commandTypeInfoParser.d.ts.map