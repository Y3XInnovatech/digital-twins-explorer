...
exports.TelemetryInfoImpl = void 0;
...
class TelemetryInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.TelemetryInfoParser;
    ...
    doesHaveType(typeId) {
        return (TelemetryInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.TelemetryInfoImpl = TelemetryInfoImpl;
//# sourceMappingURL=telemetryInfoImpl.js.map