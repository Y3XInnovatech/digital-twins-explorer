...
exports.FloatInfoParser = void 0;
...
class FloatInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (FloatInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.FloatInfoParser = FloatInfoParser;
//# sourceMappingURL=floatInfoParser.js.map