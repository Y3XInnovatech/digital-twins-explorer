...
export declare class MapInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: MapInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=mapInfoParser.d.ts.map