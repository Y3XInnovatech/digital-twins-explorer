...
exports.TelemetryInfoParser = void 0;
...
class TelemetryInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (TelemetryInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.TelemetryInfoParser = TelemetryInfoParser;
//# sourceMappingURL=telemetryInfoParser.js.map