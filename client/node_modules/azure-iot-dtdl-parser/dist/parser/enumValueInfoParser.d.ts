...
export declare class EnumValueInfoParser {
    protected static _concreteKinds: {
        [x: number]: EnumValueKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: EnumValueInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=enumValueInfoParser.d.ts.map