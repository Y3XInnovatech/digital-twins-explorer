...
exports.RelationshipInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:maxMultiplicity;2":
                    elementInfo.maxMultiplicity = valueParser_1.ValueParser.parseSingularIntegerToken(elementInfo.id, "maxMultiplicity", propValue, 1, 500, parsingErrors);
                    continue;
                case "minMultiplicity":
                case "dtmi:dtdl:property:minMultiplicity;2":
                    elementInfo.minMultiplicity = valueParser_1.ValueParser.parseSingularIntegerToken(elementInfo.id, "minMultiplicity", propValue, 0, 0, parsingErrors);
                    continue;
                case "name":
                ...
                case "dtmi:dtdl:property:properties;2":
                    valueCount = parserCollection_1.ParserCollection.PropertyInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._propertiesValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "properties", "name", undefined, false, true, allowIdReferenceSyntax, elementInfo._propertiesAllowedVersionsV2);
                    if (valueCount > 300) {
                ...
                case "dtmi:dtdl:property:target;2":
                    ...
                    const strInDtmiVal = valueParser_1.ValueParser.parseSingularIdentifierToken(elementInfo.id, "target", propValue, 2048, elementInfo.targetPropertyRegexPatternV2, parsingErrors);
                    elementInfo.target = strInDtmiVal;
                    continue;
                case "writable":
                case "dtmi:dtdl:property:writable;2":
                    elementInfo.writable = valueParser_1.ValueParser.parseSingularBooleanToken(elementInfo.id, "writable", propValue, parsingErrors);
                    continue;
            }
            if (RelationshipInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:properties;3":
                    parserCollection_1.ParserCollection.PropertyInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._propertiesValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "properties", "name", undefined, false, true, allowIdReferenceSyntax, elementInfo._propertiesAllowedVersionsV3);
                    continue;
                case "target":
                case "dtmi:dtdl:property:target;3":
                    // eslint-disable-next-line no-case-declarations
                    const strInDtmiVal = valueParser_1.ValueParser.parseSingularIdentifierToken(elementInfo.id, "target", propValue, 2048, elementInfo.targetPropertyRegexPatternV3, parsingErrors);
                    elementInfo.target = strInDtmiVal;
                    continue;
                case "writable":
...
exports.RelationshipInfoParser = RelationshipInfoParser;
//# sourceMappingURL=relationshipInfoParser.js.map