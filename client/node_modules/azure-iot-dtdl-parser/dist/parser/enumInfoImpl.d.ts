...
export declare class EnumInfoImpl implements EnumInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    _enumValuesValueConstraints: ValueConstraint[];
    private _enumValuesInstanceProperties;
    _enumValuesAllowedVersionsV2: Set<number>;
    _enumValuesAllowedVersionsV3: Set<number>;
    languageVersion?: number;
    valueSchema?: PrimitiveSchemaInfo;
    _valueSchemaValueConstraints: ValueConstraint[];
    private _valueSchemaInstanceProperties;
    _valueSchemaAllowedVersionsV2: Set<number>;
    _valueSchemaAllowedVersionsV3: Set<number>;
    parserClass: Parser;
...
//# sourceMappingURL=enumInfoImpl.d.ts.map