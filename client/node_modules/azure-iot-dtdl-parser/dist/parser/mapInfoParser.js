        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:mapKey;2":
                    ...
                    valueCount = parserCollection_1.ParserCollection.MapKeyInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._mapKeyValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "mapKey", undefined, undefined, false, false, allowIdReferenceSyntax, elementInfo._mapKeyAllowedVersionsV2);
                    if (valueCount < 1) {
                ...
                case "dtmi:dtdl:property:mapValue;2":
                    ...
                    valueCount = parserCollection_1.ParserCollection.MapValueInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._mapValueValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "mapValue", undefined, undefined, false, false, allowIdReferenceSyntax, elementInfo._mapValueAllowedVersionsV2);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
            ...
            if (MapInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:mapKey;3":
                    mapKeyPropertyMissing = false;
                    valueCount = parserCollection_1.ParserCollection.MapKeyInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._mapKeyValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "mapKey", undefined, undefined, false, false, allowIdReferenceSyntax, elementInfo._mapKeyAllowedVersionsV3);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
                            cause: `{primaryId:p} property 'mapKey' has value valueCount values, but the required minimum count is 1`,
                            action: `Add one or more 'mapKey' to the object until the minimum count is satisfied.`,
                ...
                case "dtmi:dtdl:property:mapValue;3":
                    mapValuePropertyMissing = false;
                    valueCount = parserCollection_1.ParserCollection.MapValueInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._mapValueValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "mapValue", undefined, undefined, false, false, allowIdReferenceSyntax, elementInfo._mapValueAllowedVersionsV3);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
                            cause: `{primaryId:p} property 'mapValue' has value valueCount values, but the required minimum count is 1`,
                            action: `Add one or more 'mapValue' to the object until the minimum count is satisfied.`,
...
exports.MapInfoParser = MapInfoParser;
//# sourceMappingURL=mapInfoParser.js.map