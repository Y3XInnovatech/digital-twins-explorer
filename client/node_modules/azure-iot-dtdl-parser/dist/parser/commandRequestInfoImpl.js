...
exports.CommandRequestInfoImpl = void 0;
...
class CommandRequestInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.CommandRequestInfoParser;
    ...
    doesHaveType(typeId) {
        return (CommandRequestInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.CommandRequestInfoImpl = CommandRequestInfoImpl;
//# sourceMappingURL=commandRequestInfoImpl.js.map