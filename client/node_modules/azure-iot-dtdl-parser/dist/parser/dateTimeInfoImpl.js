...
exports.DateTimeInfoImpl = void 0;
...
class DateTimeInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.DateTimeInfoParser;
        this._elementValueInstanceRegexPatternV2 = /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
        this._elementValueInstanceRegexPatternV3 = /^[0-9]{4}-[0-9]{2}-[0-9]{2}T[0-9]{2}:[0-9]{2}:[0-9]{2}(?:\.[0-9]+)?(?:Z|(?:\+|-)[0-9]{2}:[0-9]{2})$/;
    ...
    doesHaveType(typeId) {
        return (DateTimeInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.DateTimeInfoImpl = DateTimeInfoImpl;
//# sourceMappingURL=dateTimeInfoImpl.js.map