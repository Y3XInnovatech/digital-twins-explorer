...
export declare class EnumInfoParser {
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: EnumInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=enumInfoParser.d.ts.map