...
exports.LatentTypeInfoParser = void 0;
...
class LatentTypeInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (LatentTypeInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.LatentTypeInfoParser = LatentTypeInfoParser;
//# sourceMappingURL=latentTypeInfoParser.js.map