...
export declare class DoubleInfoParser {
    protected static _concreteKinds: {
        [x: number]: DoubleKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: DoubleInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=doubleInfoParser.d.ts.map