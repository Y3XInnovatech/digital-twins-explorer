...
export declare class MapValueInfoParser {
    protected static _concreteKinds: {
        [x: number]: MapValueKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: MapValueInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=mapValueInfoParser.d.ts.map