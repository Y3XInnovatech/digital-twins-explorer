...
class StringInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.StringInfoParser;
    ...
    doesHaveType(typeId) {
        return (StringInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.StringInfoImpl = StringInfoImpl;
//# sourceMappingURL=stringInfoImpl.js.map