...
export declare class DateTimeInfoParser {
    protected static _concreteKinds: {
        [x: number]: DateTimeKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: DateTimeInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=dateTimeInfoParser.d.ts.map