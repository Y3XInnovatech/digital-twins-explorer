...
exports.ArrayInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:elementSchema;2":
                    ...
                    valueCount = parserCollection_1.ParserCollection.SchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._elementSchemaValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "elementSchema", undefined, undefined, false, true, allowIdReferenceSyntax, elementInfo._elementSchemaAllowedVersionsV2);
                    if (valueCount < 1) {
            ...
            if (ArrayInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:elementSchema;3":
                    elementSchemaPropertyMissing = false;
                    valueCount = parserCollection_1.ParserCollection.SchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._elementSchemaValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "elementSchema", undefined, undefined, false, true, allowIdReferenceSyntax, elementInfo._elementSchemaAllowedVersionsV3);
                    if (valueCount < 1) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountBelowMin", {
                            cause: `{primaryId:p} property 'elementSchema' has value valueCount values, but the required minimum count is 1`,
                            action: `Add one or more 'elementSchema' to the object until the minimum count is satisfied.`,
...
exports.ArrayInfoParser = ArrayInfoParser;
//# sourceMappingURL=arrayInfoParser.js.map