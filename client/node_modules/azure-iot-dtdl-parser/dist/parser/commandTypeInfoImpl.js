...
exports.CommandTypeInfoImpl = void 0;
...
class CommandTypeInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.CommandTypeInfoParser;
    ...
    doesHaveType(typeId) {
        return (CommandTypeInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.CommandTypeInfoImpl = CommandTypeInfoImpl;
//# sourceMappingURL=commandTypeInfoImpl.js.map