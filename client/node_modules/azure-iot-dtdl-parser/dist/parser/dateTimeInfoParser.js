...
exports.DateTimeInfoParser = void 0;
...
class DateTimeInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (DateTimeInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.DateTimeInfoParser = DateTimeInfoParser;
//# sourceMappingURL=dateTimeInfoParser.js.map