...
class LongInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.LongInfoParser;
    ...
    doesHaveType(typeId) {
        return (LongInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.LongInfoImpl = LongInfoImpl;
//# sourceMappingURL=longInfoImpl.js.map