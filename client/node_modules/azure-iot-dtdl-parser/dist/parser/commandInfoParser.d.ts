...
export declare class CommandInfoParser {
    protected static _concreteKinds: {
        [x: number]: CommandKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: CommandInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=commandInfoParser.d.ts.map