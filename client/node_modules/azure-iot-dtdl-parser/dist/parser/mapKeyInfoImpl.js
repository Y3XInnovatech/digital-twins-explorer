...
class MapKeyInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this._schemaAllowedVersionsV3 = new Set().add(3);
        this.parserClass = parserCollection_1.ParserCollection.MapKeyInfoParser;
    ...
    doesHaveType(typeId) {
        return (MapKeyInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.MapKeyInfoImpl = MapKeyInfoImpl;
//# sourceMappingURL=mapKeyInfoImpl.js.map