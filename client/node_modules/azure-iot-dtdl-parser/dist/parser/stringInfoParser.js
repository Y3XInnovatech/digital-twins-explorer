...
exports.StringInfoParser = void 0;
...
class StringInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (StringInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.StringInfoParser = StringInfoParser;
//# sourceMappingURL=stringInfoParser.js.map