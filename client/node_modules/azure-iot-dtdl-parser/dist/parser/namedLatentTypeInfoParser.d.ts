...
export declare class NamedLatentTypeInfoParser {
    protected static _concreteKinds: {
        [x: number]: NamedLatentTypeKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: NamedLatentTypeInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=namedLatentTypeInfoParser.d.ts.map