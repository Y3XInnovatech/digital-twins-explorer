...
exports.BooleanInfoImpl = void 0;
...
class BooleanInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.BooleanInfoParser;
    ...
    doesHaveType(typeId) {
        return (BooleanInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.BooleanInfoImpl = BooleanInfoImpl;
//# sourceMappingURL=booleanInfoImpl.js.map