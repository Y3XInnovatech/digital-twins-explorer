...
exports.ComponentInfoImpl = void 0;
...
class ComponentInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.ComponentInfoParser;
    ...
    doesHaveType(typeId) {
        return (ComponentInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
    ...
    parsingErrors) {
        ...
        const excludedComponentElementId = { ref: undefined };
        ...
        if (excludedComponentElementId.ref !== undefined) {
            parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:excludedType", {
...
exports.ComponentInfoImpl = ComponentInfoImpl;
//# sourceMappingURL=componentInfoImpl.js.map