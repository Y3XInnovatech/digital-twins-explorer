...
exports.PropertyInfoParser = void 0;
...
class PropertyInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (PropertyInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.PropertyInfoParser = PropertyInfoParser;
//# sourceMappingURL=propertyInfoParser.js.map