...
export declare class PropertyInfoParser {
    protected static _concreteKinds: {
        [x: number]: PropertyKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: PropertyInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=propertyInfoParser.d.ts.map