...
exports.BooleanInfoParser = void 0;
...
class BooleanInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (BooleanInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.BooleanInfoParser = BooleanInfoParser;
//# sourceMappingURL=booleanInfoParser.js.map