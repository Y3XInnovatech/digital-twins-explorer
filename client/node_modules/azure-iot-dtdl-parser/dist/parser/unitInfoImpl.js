...
class UnitInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.UnitInfoParser;
    ...
    static initialize() {
        this._versionlessTypes = new Set().add("dtmi:dtdl:class:Entity").add("dtmi:dtdl:class:Unit");
    }
    addType(
    ...
    doesHaveType(typeId) {
        return (UnitInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.UnitInfoImpl = UnitInfoImpl;
//# sourceMappingURL=unitInfoImpl.js.map