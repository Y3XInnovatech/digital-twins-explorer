...
exports.ObjectInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:fields;2":
                    valueCount = parserCollection_1.ParserCollection.FieldInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._fieldsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "fields", "name", undefined, false, false, allowIdReferenceSyntax, elementInfo._fieldsAllowedVersionsV2);
                    if (valueCount < 1) {
            ...
            if (ObjectInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:fields;3":
                    parserCollection_1.ParserCollection.FieldInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._fieldsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, definedIn !== null && definedIn !== void 0 ? definedIn : elementInfo.id, "fields", "name", undefined, false, false, allowIdReferenceSyntax, elementInfo._fieldsAllowedVersionsV3);
                    continue;
            }
            if (ObjectInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
...
exports.ObjectInfoParser = ObjectInfoParser;
//# sourceMappingURL=objectInfoParser.js.map