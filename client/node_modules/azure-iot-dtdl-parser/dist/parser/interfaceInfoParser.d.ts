...
export declare class InterfaceInfoParser {
    protected static _concreteKinds: {
        [x: number]: InterfaceKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: InterfaceInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=interfaceInfoParser.d.ts.map