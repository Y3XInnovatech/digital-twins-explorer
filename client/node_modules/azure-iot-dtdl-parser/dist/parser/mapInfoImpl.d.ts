...
export declare class MapInfoImpl implements MapInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    mapKey?: MapKeyInfo;
    _mapKeyValueConstraints: ValueConstraint[];
    private _mapKeyInstanceProperties;
    _mapKeyAllowedVersionsV2: Set<number>;
    _mapKeyAllowedVersionsV3: Set<number>;
    mapValue?: MapValueInfo;
    _mapValueValueConstraints: ValueConstraint[];
    private _mapValueInstanceProperties;
    _mapValueAllowedVersionsV2: Set<number>;
    _mapValueAllowedVersionsV3: Set<number>;
    parserClass: Parser;
...
//# sourceMappingURL=mapInfoImpl.d.ts.map