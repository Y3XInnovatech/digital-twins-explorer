...
export declare class InterfaceInfoImpl implements InterfaceInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    _contentsValueConstraints: ValueConstraint[];
    private _contentsInstanceProperties;
    _contentsAllowedVersionsV2: Set<number>;
    _contentsAllowedVersionsV3: Set<number>;
    description?: LanguageStringType;
    displayName?: LanguageStringType;
    extends?: InterfaceInfo[];
    _extendsValueConstraints: ValueConstraint[];
    private _extendsInstanceProperties;
    _extendsAllowedVersionsV2: Set<number>;
    _extendsAllowedVersionsV3: Set<number>;
    languageVersion?: number;
    schemas?: ComplexSchemaInfo[];
    _schemasValueConstraints: ValueConstraint[];
    private _schemasInstanceProperties;
    _schemasAllowedVersionsV2: Set<number>;
    _schemasAllowedVersionsV3: Set<number>;
    parserClass: Parser;
    ...
    validateInstanceV2(instanceElt: unknown, instanceName: string | undefined): boolean;
...
//# sourceMappingURL=interfaceInfoImpl.d.ts.map