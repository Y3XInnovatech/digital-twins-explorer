...
export declare class MapKeyInfoParser {
    protected static _concreteKinds: {
        [x: number]: MapKeyKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: MapKeyInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=mapKeyInfoParser.d.ts.map