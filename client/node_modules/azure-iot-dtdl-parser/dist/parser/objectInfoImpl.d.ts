...
export declare class ObjectInfoImpl implements ObjectInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    fields?: FieldInfo[];
    _fieldsValueConstraints: ValueConstraint[];
    private _fieldsInstanceProperties;
    _fieldsAllowedVersionsV2: Set<number>;
    _fieldsAllowedVersionsV3: Set<number>;
...
//# sourceMappingURL=objectInfoImpl.d.ts.map