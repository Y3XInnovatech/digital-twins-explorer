...
exports.IntegerInfoParser = void 0;
...
class IntegerInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (IntegerInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.IntegerInfoParser = IntegerInfoParser;
//# sourceMappingURL=integerInfoParser.js.map