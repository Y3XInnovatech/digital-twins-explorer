...
exports.InterfaceInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:contents;2":
                    valueCount = parserCollection_1.ParserCollection.ContentInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._contentsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "contents", "name", "name", false, true, allowIdReferenceSyntax, elementInfo._contentsAllowedVersionsV2);
                    if (valueCount > 300) {
                ...
                case "dtmi:dtdl:property:extends;2":
                    valueCount = parserCollection_1.ParserCollection.InterfaceInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._extendsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "extends", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._extendsAllowedVersionsV2);
                    if (valueCount > 2) {
                        parsingErrors.push((0, parsingErrorImpl_1.createParsingError)("dtmi:dtdl:parsingError:propertyCountAboveMax", {
                ...
                case "dtmi:dtdl:property:schemas;2":
                    parserCollection_1.ParserCollection.ComplexSchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._schemasValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "schemas", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._schemasAllowedVersionsV2);
                    continue;
            }
            if (InterfaceInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:contents;3":
                    parserCollection_1.ParserCollection.ContentInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._contentsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "contents", "name", "name", false, true, allowIdReferenceSyntax, elementInfo._contentsAllowedVersionsV3);
                    continue;
                case "description":
                ...
                case "dtmi:dtdl:property:extends;3":
                    parserCollection_1.ParserCollection.InterfaceInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._extendsValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "extends", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._extendsAllowedVersionsV3);
                    continue;
                case "schemas":
                case "dtmi:dtdl:property:schemas;3":
                    parserCollection_1.ParserCollection.ComplexSchemaInfoParser.parseToken(model, objectPropertyInfoList, elementPropertyConstraints, elementInfo._schemasValueConstraints, aggregateContext, parsingErrors, propValue, elementInfo.id, elementInfo.id, "schemas", undefined, undefined, true, true, allowIdReferenceSyntax, elementInfo._schemasAllowedVersionsV3);
                    continue;
            }
            if (InterfaceInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
...
exports.InterfaceInfoParser = InterfaceInfoParser;
//# sourceMappingURL=interfaceInfoParser.js.map