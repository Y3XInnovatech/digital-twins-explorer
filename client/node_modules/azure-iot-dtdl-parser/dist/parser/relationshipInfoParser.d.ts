...
export declare class RelationshipInfoParser {
    protected static _concreteKinds: {
        [x: number]: RelationshipKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: RelationshipInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=relationshipInfoParser.d.ts.map