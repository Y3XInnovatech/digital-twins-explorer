...
export declare class LatentTypeInfoParser {
    protected static _concreteKinds: {
        [x: number]: LatentTypeKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: LatentTypeInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=latentTypeInfoParser.d.ts.map