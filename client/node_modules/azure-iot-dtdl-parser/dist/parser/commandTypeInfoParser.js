...
exports.CommandTypeInfoParser = void 0;
...
class CommandTypeInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (CommandTypeInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.CommandTypeInfoParser = CommandTypeInfoParser;
//# sourceMappingURL=commandTypeInfoParser.js.map