...
export declare class ComponentInfoParser {
    protected static _concreteKinds: {
        [x: number]: ComponentKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: ComponentInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=componentInfoParser.d.ts.map