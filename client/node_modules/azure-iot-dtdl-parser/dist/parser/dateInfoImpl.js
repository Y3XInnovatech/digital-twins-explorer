...
class DateInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        this.parserClass = parserCollection_1.ParserCollection.DateInfoParser;
        this._elementValueInstanceRegexPatternV2 = /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/;
        this._elementValueInstanceRegexPatternV3 = /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/;
    ...
    doesHaveType(typeId) {
        return (DateInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.DateInfoImpl = DateInfoImpl;
//# sourceMappingURL=dateInfoImpl.js.map