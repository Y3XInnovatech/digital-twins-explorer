...
exports.UnitAttributeInfoImpl = void 0;
...
class UnitAttributeInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.UnitAttributeInfoParser;
    ...
    doesHaveType(typeId) {
        return (UnitAttributeInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.UnitAttributeInfoImpl = UnitAttributeInfoImpl;
//# sourceMappingURL=unitAttributeInfoImpl.js.map