...
exports.DurationInfoParser = void 0;
...
class DurationInfoParser {
    ...
    allowIdReferenceSyntax) {
        ...
        for (const propKey in object) {
            ...
            if (DurationInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.DurationInfoParser = DurationInfoParser;
//# sourceMappingURL=durationInfoParser.js.map