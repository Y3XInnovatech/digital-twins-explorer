...
export declare class RelationshipInfoImpl implements RelationshipInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    name?: string;
    namePropertyRegexPatternV2: RegExp;
    namePropertyRegexPatternV3: RegExp;
    properties?: PropertyInfo[];
    _propertiesValueConstraints: ValueConstraint[];
    private _propertiesInstanceProperties;
    _propertiesAllowedVersionsV2: Set<number>;
    _propertiesAllowedVersionsV3: Set<number>;
    target?: string;
    targetPropertyRegexPatternV2: RegExp;
    targetPropertyRegexPatternV3: RegExp;
    writable?: boolean;
    parserClass: Parser;
...
//# sourceMappingURL=relationshipInfoImpl.d.ts.map