...
export declare class StringInfoParser {
    protected static _concreteKinds: {
        [x: number]: StringKinds[];
    };
    ...
    static tryParseSupplementalProperty(model: Model, elementInfo: StringInfoImpl, objectPropertyInfoList: ParsedObjectPropertyInfo[], elementPropertyConstraints: ElementPropertyConstraint[], aggregateContext: AggregateContext, parsingErrors: ParsingError[], propName: string, propToken: any): boolean;
...
//# sourceMappingURL=stringInfoParser.d.ts.map