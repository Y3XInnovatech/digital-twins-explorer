...
exports.CommandResponseInfoImpl = void 0;
...
class CommandResponseInfoImpl {
    constructor(dtdlVersion, id, childOf, definedIn, entityKind) {
        ...
        this.parserClass = parserCollection_1.ParserCollection.CommandResponseInfoParser;
    ...
    doesHaveType(typeId) {
        return (CommandResponseInfoImpl._versionlessTypes.has(new internalDtmi_1.InDTMI(typeId).versionless) ||
...
exports.CommandResponseInfoImpl = CommandResponseInfoImpl;
//# sourceMappingURL=commandResponseInfoImpl.js.map