...
exports.EnumValueInfoParser = void 0;
        ...
        for (const propKey in object) {
            ...
            switch (propKey) {
                ...
                case "dtmi:dtdl:property:enumValue;2":
                    ...
                    const enumValueValueAndType = valueParser_1.ValueParser.parseSingularLiteralToken(elementInfo.id, "enumValue", propValue, parsingErrors);
            ...
            if (EnumValueInfoParser.tryParseSupplementalProperty(model, elementInfo, objectPropertyInfoList, elementPropertyConstraints, aggregateContext, parsingErrors, propKey, propValue)) {
                continue;
            }
...
exports.EnumValueInfoParser = EnumValueInfoParser;
//# sourceMappingURL=enumValueInfoParser.js.map