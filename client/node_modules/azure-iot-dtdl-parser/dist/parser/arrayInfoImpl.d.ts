...
export declare class ArrayInfoImpl implements ArrayInfo, TypeChecker {
    dtdlVersion: number;
    id: string;
    ...
    _elementSchemaValueConstraints: ValueConstraint[];
    private _elementSchemaInstanceProperties;
    _elementSchemaAllowedVersionsV2: Set<number>;
    _elementSchemaAllowedVersionsV3: Set<number>;
...
//# sourceMappingURL=arrayInfoImpl.d.ts.map